---
title: "C9orf72 mice - olfaction task young time point"
...
#Read data 
data_mouse <- read_csv("filtered_manvsML_C9_15Weeks_gen_corr_filtered.csv", col_types = cols (
  Video_id = 'f',
...
# Save the plot
ggsave("ManvsML_C9_15weeks_filtered_gen.tiff", plot = pEXPL_Gen_Source, width = 5, height = 3, dpi = 600) # Adjust height, width, dpi
